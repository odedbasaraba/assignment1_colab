...
def svm_loss_vectorized(W, X, y, reg):
    ...
    #############################################################################
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    # change the vals of margin to 1 for the incorrect 
    incorrect_matrix = margin
    incorrect_matrix[incorrect_matrix > 0] = 1
    row_sum = np.sum(incorrect_matrix, axis=1)
    incorrect_matrix[np.arange(num_train), y] = -row_sum

    dW = X.T.dot(incorrect_matrix)
    dW /= num_train
    dW += reg * W
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
